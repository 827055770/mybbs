...
<!--网页顶部end-->
 ...
 if(empty($_SESSION['flag'])) : ?>
            ...
            <a href="/index.php?m=home&c=login&a=logout">退出
            ...
            <div class="post_content">
                <table cellspacing="0" cellpadding="0" width="100%">
                    <tbody>
                        ...
                        <tr>
                        <th class="list_title"><?=$v['title']?>></th>
                        <th class="list_author"><?=$users[ $v['uid'] ]?></th>
                        <th class="list_count"><?=$v['rep_cnt']?>/<?=$v['vuew_cnt']?></th>
                        <th class="list_ptime"><?=date('Y-m-d H:i:s',$v['created_at'])?></th>
                    </tr>
                    <?php endforeach;?>
    ...
    <div id="friend_link">
        ...
        <div class="fri_content">
            <div class="fri_left"><img src="./images/20080926_9b2baec56b95a9ae46ab8ir8uBrEJQjx.gif"></div>
            <div class="fri_right">
