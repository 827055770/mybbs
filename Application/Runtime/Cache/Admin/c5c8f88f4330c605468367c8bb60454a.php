                        ...
                        <tbody><tr>
                            ...
                            <td>
                                <select name="auth" id="catid" class="required">
                                    ...
                                    <option <?php if($user['auth']==3){echo 'selected';} ?> value="3" > 用户</option>
                                </select>
                            </td>
                        </tr>
                            <tr>
                            ...
                            <tr>
                                <th>性别：</th>
                                <td><input class="common-text" name="sex" size="50" value="w"<?php if($user['sex']==w){echo 'checked';} ?> type="radio">女
