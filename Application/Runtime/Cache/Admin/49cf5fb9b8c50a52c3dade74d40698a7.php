                ...
                <form action="/index.php?m=admin&c=user&a=save" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                <th>性别：</th>
                                <td><input class="common-text" name="sex" size="50" value="w" type="radio" checked>女
                            ...
                            <tr>
                                ...
                                <td><input name="uface" id="" type="file"><!--<input type="submit" onclick="submitForm('/jscss/admin/design/upload')" value="上传图片"/>--></td>
                            </tr>
