    ...
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                <li><a href="#">管理员:<?=$_SESSION['userInfo']['uname']?></a></li>
                <li><a href="#">修改密码</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/index.php?m=admin&c=cate&a=update&cid=<?=$cates['cid']?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120"><i class="require-red">*</i>所属分区：</th>
                            <td>
                                <select name="pid" id="catid" class="required">
                                    <option value="<?= $cates[''] ?>">请选择</option>
                                    <?php foreach($parts as $k=>$v):?>
                                    <option value="<?=$v['pid']?>"><?=$v['pname']?></option>
                                    <?php endforeach; ?>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th width="120"><i class="require-red">*</i>版主名称：</th>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="<?=$cates[cname]?>" size="50" value="<?= $cates['cname']?>" type="text">
                                </td>
                            </tr>
